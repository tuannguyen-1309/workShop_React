  ...
  return (
    <div className="h-full mb-8">
      ...
      <div className="mt-4 px-4 pb-4 bg-[#F5F5F5]">
        ...
        <h5 className="text-base text-[#898989] pb-2">Stylish cafe chair</h5>
        <p className="text-[#EF4444] font-semibold text-xl pb-3">2.500.000đ</p>
        <Link to="cart">
...
export default OneBoxProductShop;
